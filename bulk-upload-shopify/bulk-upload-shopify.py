...
URLS = ['https://www.jdsports.co.uk/men/brand/new-balance/',
        ...
        'https://www.jdsports.co.uk/men/brand/on-running/',
        'https://www.jdsports.co.uk/women/brand/on-running/', 
        'https://www.jdsports.co.uk/men/brand/asics/', 
        'https://www.jdsports.co.uk/women/brand/asics/', 
        'https://www.jdsports.co.uk/men/brand/puma/', 
        'https://www.jdsports.co.uk/women/brand/puma/',]
            ...
            for item in data['items']:
                ...
                for variant in product_data.get('variants', []):
                    ...
                    if page_id_variant:
                        ...
                        quantity = 1  # Default if no page_id_variant
